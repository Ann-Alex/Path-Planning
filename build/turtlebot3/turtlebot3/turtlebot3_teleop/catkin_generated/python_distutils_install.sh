...
echo_and_run cd "/home/alvina/new_proj/src/turtlebot3/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/home/alvina/new_proj/src/turtlebot3/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/alvina/new_proj/build/turtlebot3/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
