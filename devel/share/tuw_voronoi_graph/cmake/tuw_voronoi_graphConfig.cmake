...
if("TRUE" STREQUAL "TRUE")
  set(tuw_voronoi_graph_SOURCE_PREFIX /home/alvina/new_proj/src/tuv/tuw_multi_robot/tuw_voronoi_graph)
  set(tuw_voronoi_graph_DEVEL_PREFIX /home/alvina/new_proj/devel)
  ...
  set(tuw_voronoi_graph_INSTALL_PREFIX /home/alvina/new_proj/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tuw_voronoi_graph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alvina/new_proj/src/tuv/tuw_multi_robot/tuw_voronoi_graph/${idir}'.  ${_report}")
    endif()
