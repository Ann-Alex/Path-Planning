...
;//! \htmlinclude IwsCmdVRATVec.msg.html

(cl:defclass <IwsCmdVRATVec> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass IwsCmdVRATVec (<IwsCmdVRATVec>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <IwsCmdVRATVec>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'IwsCmdVRATVec)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tuw_nav_msgs-msg:<IwsCmdVRATVec> is deprecated: use tuw_nav_msgs-msg:IwsCmdVRATVec instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <IwsCmdVRATVec>))
...
(cl:defmethod v-val ((m <IwsCmdVRATVec>))
...
(cl:defmethod rho-val ((m <IwsCmdVRATVec>))
...
(cl:defmethod phi-val ((m <IwsCmdVRATVec>))
...
(cl:defmethod delta_t-val ((m <IwsCmdVRATVec>))
...
(cl:defmethod state0-val ((m <IwsCmdVRATVec>))
  ...
  (state0 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <IwsCmdVRATVec>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'phi))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <IwsCmdVRATVec>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'phi) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'phi)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<IwsCmdVRATVec>)))
  "Returns string type for a message object of type '<IwsCmdVRATVec>"
  "tuw_nav_msgs/IwsCmdVRATVec")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'IwsCmdVRATVec)))
  "Returns string type for a message object of type 'IwsCmdVRATVec"
  "tuw_nav_msgs/IwsCmdVRATVec")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<IwsCmdVRATVec>)))
  "Returns md5sum for a message object of type '<IwsCmdVRATVec>"
  "ffc1d6dbf30b45c520195bc2f2064824")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'IwsCmdVRATVec)))
  "Returns md5sum for a message object of type 'IwsCmdVRATVec"
  "ffc1d6dbf30b45c520195bc2f2064824")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<IwsCmdVRATVec>)))
  "Returns full string definition for message of type '<IwsCmdVRATVec>"
  (cl:format cl:nil "Header header~%float64[] v~%float64[] rho~%float64[] phi~%float64[] delta_t~%~%float64[] state0~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'IwsCmdVRATVec)))
  "Returns full string definition for message of type 'IwsCmdVRATVec"
  (cl:format cl:nil "Header header~%float64[] v~%float64[] rho~%float64[] phi~%float64[] delta_t~%~%float64[] state0~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <IwsCmdVRATVec>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'phi) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <IwsCmdVRATVec>))
  "Converts a ROS message object to a list"
  (cl:list 'IwsCmdVRATVec
