...
class LineSegments {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LineSegments(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.segments[i] = LineSegment.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LineSegments(null);
    ...
    if (msg.segments !== undefined) {
      ...
      for (let i = 0; i < resolved.segments.length; ++i) {
        resolved.segments[i] = LineSegment.Resolve(msg.segments[i]);
      }
    }
    else {
      resolved.segments = []
