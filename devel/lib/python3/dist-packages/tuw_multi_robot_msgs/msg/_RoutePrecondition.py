...
class RoutePrecondition(genpy.Message):
  _md5sum = "5325912e1dc77bd158888f84bb4b040e"
...
int32 current_route_segment      # the segment nr of the route executed by the given robot"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       robot_id,current_route_segment
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.current_route_segment,) = _get_struct_i().unpack(str[start:end])
      return self
