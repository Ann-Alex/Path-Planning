...
"""autogenerated by genpy from tuw_multi_robot_msgs/OrderArray.msg. Do not edit."""
import codecs
import sys
...
class OrderArray(genpy.Message):
  _md5sum = "bbc022246db3f3814b8f8dca9834219a"
  _type = "tuw_multi_robot_msgs/OrderArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','tuw_multi_robot_msgs/Order[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OrderArray, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = tuw_multi_robot_msgs.msg.Order()
        _v8 = val1.header
        start = end
        end += 4
        ...
        (val1.order_id,) = _get_struct_i().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.order_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.order_name = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.stations = []
        for i in range(0, length):
          val2 = tuw_multi_robot_msgs.msg.Station()
          _v10 = val2.header
          start = end
          end += 4
