...
"""autogenerated by genpy from tuw_local_controller_msgs/ExecutePathActionResult.msg. Do not edit."""
import codecs
import sys
...
class ExecutePathActionResult(genpy.Message):
  _md5sum = "b609b85cfb09d0307974610e79f407d5"
  _type = "tuw_local_controller_msgs/ExecutePathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tuw_local_controller_msgs/ExecutePathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = tuw_local_controller_msgs.msg.ExecutePathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tuw_local_controller_msgs.msg.ExecutePathResult()
