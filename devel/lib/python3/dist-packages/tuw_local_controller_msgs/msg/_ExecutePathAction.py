...
"""autogenerated by genpy from tuw_local_controller_msgs/ExecutePathAction.msg. Do not edit."""
import codecs
import sys
...
import nav_msgs.msg
import std_msgs.msg
import tuw_local_controller_msgs.msg

class ExecutePathAction(genpy.Message):
  _md5sum = "8599cb873966dfaaabf4f5556a1057f0"
  _type = "tuw_local_controller_msgs/ExecutePathAction"
...
"""
  ...
  _slot_types = ['tuw_local_controller_msgs/ExecutePathActionGoal','tuw_local_controller_msgs/ExecutePathActionResult','tuw_local_controller_msgs/ExecutePathActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = tuw_local_controller_msgs.msg.ExecutePathActionGoal()
      if self.action_result is None:
        self.action_result = tuw_local_controller_msgs.msg.ExecutePathActionResult()
      if self.action_feedback is None:
        self.action_feedback = tuw_local_controller_msgs.msg.ExecutePathActionFeedback()
    else:
      self.action_goal = tuw_local_controller_msgs.msg.ExecutePathActionGoal()
      self.action_result = tuw_local_controller_msgs.msg.ExecutePathActionResult()
      self.action_feedback = tuw_local_controller_msgs.msg.ExecutePathActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.action_result.result.pose.position.x, _x.action_result.result.pose.position.y, _x.action_result.result.pose.position.z, _x.action_result.result.pose.orientation.x, _x.action_result.result.pose.orientation.y, _x.action_result.result.pose.orientation.z, _x.action_result.result.pose.orientation.w, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.pose.position.x, _x.action_result.result.pose.position.y, _x.action_result.result.pose.position.z, _x.action_result.result.pose.orientation.x, _x.action_result.result.pose.orientation.y, _x.action_result.result.pose.orientation.z, _x.action_result.result.pose.orientation.w, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_7d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
