...
"""autogenerated by genpy from tuw_geometry_msgs/WeightedPoseWithCovarianceArray.msg. Do not edit."""
import codecs
import sys
...
class WeightedPoseWithCovarianceArray(genpy.Message):
  _md5sum = "f611e94fdb32f52eaee4a5137d1fa202"
  _type = "tuw_geometry_msgs/WeightedPoseWithCovarianceArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','tuw_geometry_msgs/WeightedPoseWithCovariance[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WeightedPoseWithCovarianceArray, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = tuw_geometry_msgs.msg.WeightedPoseWithCovariance()
        _v4 = val1.pose
        _v5 = _v4.position
        _x = _v5
        start = end
